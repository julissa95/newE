...
<div class="container">
  <form action="hacerregistro.php" novalidate>
    ...
    <input type="text" class="form-control" name="Nombre" id="nombre" aria-describedby="Tunombre" placeholder="Tu nombre" value="">
    <small id="emailHelp" class="form-text text-muted">Tu nombre es requerido.</small>
  </div>
  <div class="form-group">
    <label for="apellido">Apellido</label>
   <input type="text" name="Apellido" value=""  class="form-control" aria-describedby="Apellido" placeholder="Tu apellido">
  </div>
